...
st.title('文字起こしアプリ')
st.header('概要')
st.write('こちらは Google Cloud Speech-to-Text を利用した文字起こしアプリです。リンクは下記です。')
...
if upload_file is not None:
    ...
    st.subheader('ファイル詳細')
    file_details = {'ファイル名': upload_file.name, '形式':upload_file.type, 'サイズ':upload_file.size}
